...
- `source_exposure_attestation`: one atomic, content-free provider-request-digest and serialization-proof binding for each newly inserted detailed source exposure
