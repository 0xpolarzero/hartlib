  ...
  tasks: z
    .array(
      z.object({
        id: z.string(),
        purpose: z.string(),
        agent: z.string().describe("agents.read | agents.write | agents.review | agents.ui | agents.uiReview | agents.mechanical | (none) for a function task."),
  ...
  return (
    <Workflow name="create-workflow">
      ...
      <Sequence>
        ...
        <Task id="clarify" output={outputs.clarify} agent={agents.review}>
          <ClarifyPrompt
        ...
        {provision ? (
          <Task id="design" output={outputs.design} agent={agents.review}>
            <DesignPrompt
              spec={clarify}
        ...
        {proceed && verifyPassed ? (
          <Loop id="skill:loop" until={skillReady} maxIterations={3} onMaxReached="fail">
            <Sequence>
              <Task id="document" output={outputs.document} agent={agents.mechanical}>
                <DocumentPrompt
                  workflowName={workflowName}
                  design={design}
