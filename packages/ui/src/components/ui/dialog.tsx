...
export type DialogProps = ComponentProps<typeof DialogPrimitive.Root> & { locale?: string };
export function Dialog({ locale: _locale, ...props }: DialogProps) {
...
export function AlertDialog({ locale: _locale, ...props }: AlertDialogProps) {
...
export const AlertDialogContent = forwardRef<
  HTMLDivElement,
  React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Content> & { hideClose?: boolean }
>(({ className, hideClose: _hideClose, ...props }, ref) => (
