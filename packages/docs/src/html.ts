import { standaloneDocumentCss } from "@hartlib/ui/styles/document";

// Static English-only chat reference served at /docs.
// The docs Vite plugin serves this HTML verbatim. Every path stays outside the
// localized application layout, so the page has no fr/en locale switch.
//
