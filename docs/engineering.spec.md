...
- decode and validate captured path parameters through shared Effect schemas before dispatch, then pass those validated values to adapters instead of reparsing raw URLs
