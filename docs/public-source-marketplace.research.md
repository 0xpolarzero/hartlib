...
| Assemblée nationale    | Parliamentary communications and documents.                                              | Use official parliamentary document discovery and official per-document HTML representations.                                                                                                                      | Stored official HTML, normalized text. |    `4,981` chars per page |
...
- Assemblée nationale stores the official opendata HTML document representation and rejects landing page shells or unsupported second-fetch media.
