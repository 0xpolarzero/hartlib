  ...
  return (
    <Workflow name="upgrade">
      <Sequence>
        ...
        {gather ? (
          <Task id="cheap-upgrade" output={outputs.cheapUpgrade} agent={agents.mechanical} timeoutMs={20 * 60_000}>
...
- versionAfter: verified version string when available.`}
        ...
        {gather && needsSmart ? (
          <Task id="smart-upgrade" output={outputs.smartUpgrade} agent={agents.write} timeoutMs={45 * 60_000}>
